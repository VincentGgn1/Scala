...
$c_Lcalculator_Calculator$.prototype.contain__Lcalculator_Expr__Lcalculator_Ref__Z = (function(expr, ref) {
  _contain: while (true) {
    var x1 = expr;
    if ($is_Lcalculator_Ref(x1)) {
      var x6 = $as_Lcalculator_Ref(x1);
      return (x6.name$2 === ref.name$2)
    };
    if ($is_Lcalculator_Minus(x1)) {
      var x2 = $as_Lcalculator_Minus(x1);
      var a = x2.a$2;
      var b = x2.b$2;
      if ((a !== null)) {
        if ((b !== null)) {
          if (this.contain__Lcalculator_Expr__Lcalculator_Ref__Z(a, ref)) {
            expr = b;
            continue _contain
          } else {
            return false
    ...
    if ($is_Lcalculator_Times(x1)) {
      var x3 = $as_Lcalculator_Times(x1);
      var a$2 = x3.a$2;
      var b$2 = x3.b$2;
      if ((a$2 !== null)) {
        if ((b$2 !== null)) {
          if (this.contain__Lcalculator_Expr__Lcalculator_Ref__Z(a$2, ref)) {
            expr = b$2;
            continue _contain
          } else {
            return false
    ...
    if ($is_Lcalculator_Divide(x1)) {
      var x4 = $as_Lcalculator_Divide(x1);
      var a$3 = x4.a$2;
      var b$3 = x4.b$2;
      if ((a$3 !== null)) {
        if ((b$3 !== null)) {
          if (this.contain__Lcalculator_Expr__Lcalculator_Ref__Z(a$3, ref)) {
            expr = b$3;
            continue _contain
          } else {
            return false
    ...
    if ($is_Lcalculator_Plus(x1)) {
      var x5 = $as_Lcalculator_Plus(x1);
      var a$4 = x5.a$2;
      var b$4 = x5.b$2;
      if ((a$4 !== null)) {
        if ((b$4 !== null)) {
          if (this.contain__Lcalculator_Expr__Lcalculator_Ref__Z(a$4, ref)) {
            expr = b$4;
            continue _contain
          } else {
            return false
...
$c_Lcalculator_Calculator$.prototype.computeValues__sci_Map__sci_Map = (function(namedExpressions) {
  var f = new $c_Lcalculator_Calculator$$anonfun$1().init___sci_Map(namedExpressions);
  var this$1 = $m_sci_Map$();
  var bf = new $c_scg_GenMapFactory$MapCanBuildFrom().init___scg_GenMapFactory(this$1);
  var result = $as_sci_Map($s_sc_TraversableLike$class__map__sc_TraversableLike__F1__scg_CanBuildFrom__O(namedExpressions, f, bf));
  return result
});
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _eval: while (true) {
    ...
    if ($is_Lcalculator_Minus(x1)) {
      var x3 = $as_Lcalculator_Minus(x1);
      var a$2 = x3.a$2;
      var b$2 = x3.b$2;
      if ((a$2 !== null)) {
        if ((b$2 !== null)) {
    ...
    if ($is_Lcalculator_Times(x1)) {
      var x4 = $as_Lcalculator_Times(x1);
      var a$3 = x4.a$2;
      var b$3 = x4.b$2;
      if ((a$3 !== null)) {
        if ((b$3 !== null)) {
    ...
    if ($is_Lcalculator_Divide(x1)) {
      var x5 = $as_Lcalculator_Divide(x1);
      var a$4 = x5.a$2;
      var b$4 = x5.b$2;
      if ((a$4 !== null)) {
        if ((b$4 !== null)) {
          return ((this.eval__Lcalculator_Expr__sci_Map__D(b$4, references) !== 0) ? (this.eval__Lcalculator_Expr__sci_Map__D(a$4, references) / this.eval__Lcalculator_Expr__sci_Map__D(b$4, references)) : (NaN))
        }
      }
    };
    if ($is_Lcalculator_Literal(x1)) {
      var x14 = $as_Lcalculator_Literal(x1);
      var x = expr;
    ...
    if ($is_Lcalculator_Ref(x1)) {
      var x15 = $as_Lcalculator_Ref(x1);
      var key = x15.name$2;
      if (($s_sc_MapLike$class__contains__sc_MapLike__O__Z(references, key) && (!this.contain__Lcalculator_Expr__Lcalculator_Ref__Z($as_Lcalculator_Expr($as_Lcalculator_Signal(references.apply__O__O(x15.name$2)).apply__O()), x15)))) {
        expr = this.getReferenceExpr__p1__T__sci_Map__Lcalculator_Expr(x15.name$2, references);
        continue _eval
      } else {
        return (NaN)
      }
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, delta$1) {
    return (function() {
      if (($uD(delta$1.apply__O()) < 0)) {
        ...
        var x1 = (((-jsx$2) - $uD($g.Math.sqrt(x))) / (2 * $uD(a$2.apply__O())));
        var jsx$3 = $uD(b$2.apply__O());
        var x$1 = $uD(delta$1.apply__O());
        var x2 = (((-jsx$3) + $uD($g.Math.sqrt(x$1))) / (2 * $uD(a$2.apply__O())));
        var array$1 = [x1, x2];
        if (($uI(array$1.length) === 0)) {
          ...
          var jsx$4 = b$3.elems$1
        };
        return $as_sci_Set(jsx$4)
      }
    })
  })(a, b, delta));
  return new $c_Lcalculator_Signal().init___F0(expr)
...
$c_Lcalculator_Signal.prototype.computeValue__V = (function() {
  ...
  if ((!$m_sr_BoxesRunTime$().equals__O__O__Z(this.myValue$1, newValue))) {
...
$c_Lcalculator_TweetLength$.prototype.tweetRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(tweetText) {
  this.calculator$TweetLength$$tweetLength__T__I($as_T(tweetText.apply__O()));
...
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(remainingCharsCount$1) {
    return (function() {
      ...
      return (((remain >= 0) && (remain < 15)) ? "orange" : ((remain < 0) ? "red" : "green"))
    })
  })(remainingCharsCount));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
...
/** @constructor */
function $c_Lcalculator_Calculator$$anonfun$1() {
  $c_sr_AbstractFunction1.call(this);
  this.namedExpressions$1$f = null
}
$c_Lcalculator_Calculator$$anonfun$1.prototype = new $h_sr_AbstractFunction1();
$c_Lcalculator_Calculator$$anonfun$1.prototype.constructor = $c_Lcalculator_Calculator$$anonfun$1;
/** @constructor */
function $h_Lcalculator_Calculator$$anonfun$1() {
  /*<skip>*/
}
$h_Lcalculator_Calculator$$anonfun$1.prototype = $c_Lcalculator_Calculator$$anonfun$1.prototype;
$c_Lcalculator_Calculator$$anonfun$1.prototype.apply__O__O = (function(v1) {
  return this.apply__T2__T2($as_T2(v1))
});
$c_Lcalculator_Calculator$$anonfun$1.prototype.init___sci_Map = (function(namedExpressions$1) {
  this.namedExpressions$1$f = namedExpressions$1;
  return this
});
$c_Lcalculator_Calculator$$anonfun$1.prototype.apply__T2__T2 = (function(x0$1) {
  if ((x0$1 !== null)) {
    var e = $as_T(x0$1.$$und1$f);
    var k = $as_Lcalculator_Signal(x0$1.$$und2$f);
    var x = ((e + " ") + k);
    var this$2 = $m_s_Console$();
    var this$3 = $as_Ljava_io_PrintStream(this$2.outVar$2.v$1);
    this$3.java$lang$JSConsoleBasedPrintStream$$printString__T__V((x + "\n"));
    $m_Lcalculator_Signal$();
    var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, k$1) {
      return (function() {
        return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr(k$1.apply__O()), arg$outer.namedExpressions$1$f)
      })
    })(this, k));
    return new $c_T2().init___O__O(e, new $c_Lcalculator_Signal().init___F0(expr))
  } else {
    throw new $c_s_MatchError().init___O(x0$1)
  }
});
var $d_Lcalculator_Calculator$$anonfun$1 = new $TypeData().initClass({
  Lcalculator_Calculator$$anonfun$1: 0
}, false, "calculator.Calculator$$anonfun$1", {
  Lcalculator_Calculator$$anonfun$1: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Lcalculator_Calculator$$anonfun$1.prototype.$classData = $d_Lcalculator_Calculator$$anonfun$1;
/** @constructor */
